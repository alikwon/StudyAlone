...
*/
public class Day210303_1_2 {
	public String solution(String new_id) {
		//1.소문자 치환
		String id=new_id.toLowerCase();
		//2.소문자,숫자,-_. 빼고 나머지 제외 --> 아닌건 공백으로 치환 -->[]안에 ^이 선행되면 "not"
		id = id.replaceAll("[^-_.a-z0-9]", "");
		//3.연속된 "." 은 하나만 --> 2개 이상 반복되는거 1개로 치환
		id = id.replaceAll("[.]{2,}", ".");
		//4."."이 처음이나 끝인거 빼기 -->시작과 끝의 .은 공백으로 치환
		id = id.replaceAll("^[.]|[.]$", "");
		//5.빈문자열이라면, "a"대입
		if(id.length()==0) id = "a";
	...
	public static void main(String[] args) {
		Day210303_1_2 d = new Day210303_1_2();
