...
public class Day201106_1 {
	...
	public String[] solution(int n, int[] arr1, int[] arr2) {
		...
		String str;
		for (int i = 0; i < n; i++) {
			x = Long.parseLong(Integer.toBinaryString(arr1[i]));
			y = Long.parseLong(Integer.toBinaryString(arr2[i]));
			str = String.format("%" + n + "s", String.valueOf(x + y));
			answer[i] = str.replaceAll("0", " ").replaceAll("[1|2]", "#");
		}
		return answer;
	}
	...
	public String[] solution2(int n, int[] arr1, int[] arr2) {
		...
		for (int i = 0; i < n; i++) {
			...
			result[i] = str.replaceAll("1", "#").replaceAll("0", " ");
		}
		return result;
	}

	public static void main(String[] args) {
		Day201106_1 d = new Day201106_1();
		int n = 6;
		int[] arr1 = { 46, 33, 33, 22, 31, 50 };
		int[] arr2 = { 27, 56, 19, 14, 14, 10 };
		String[] result = d.solution(n, arr1, arr2);
